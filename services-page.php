...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			//get featured areas
			the_business_wp_featured_area($the_business_wp_option['service_featured_area_1']);
			the_business_wp_featured_area($the_business_wp_option['service_featured_area_2']);
			?>				
		</main><!-- #main -->
	</div><!-- #primary -->
